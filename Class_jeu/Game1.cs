                ...
                case var _ when state.IsKeyDown(Keys.Enter) && !previousKeyboardState.IsKeyDown(Keys.Enter):
                    switch (selectedOption)
                    {
                        case 0:
                                ...
                                XmlScoreHandler.IncrementElement("src/data/xml/Init_Game.xml","//tot_games_played");
                                ////////////////////////////////////////////////////////////////////////////////////////////
            ...
            if (state.IsKeyDown(Keys.Enter) && !previousKeyboardState.IsKeyDown(Keys.Enter))
            {
                switch (gameOverOption)
                {
                    case 0:
                        ...
                        currentGameState = etatJeu.Playing;
                        ///////PAUL NOTE: ADD HERE CODE FOR THE XML WRITE +1 TO GAMES PLAYED <tot_games_played>
                        XmlScoreHandler.IncrementElement("Content/src/data/xml/Init_Game.xml","//tot_games_played");
                        ////////////////////////////////////////////////////////////////////////////////////////////
                        break;
                    case 1: 
                        currentGameState = etatJeu.EXIT;
            ...
            switch (currentGameState)
            {
                ...
                case etatJeu.WIN:
                    DrawWIN(_spriteBatch);
                            ...
                            string htmlFile = Path.Combine("Content","src", "data", "html", "Init_Game.html");
